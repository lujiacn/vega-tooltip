...
$(function(){ //DOM Ready
  ...
  $("div.ggvis-output-container").on("mouseover", function() {
    //display gear
    $(this).children("div.plot-gear-icon").show();

    plot_id = $(this).children("div.ggvis-output").attr("id");
    offset = $(this).offset();
  ...
  $("div.ggvis-output-container").on("mouseout", function() {
    //hide gear
    $(this).children("div.plot-gear-icon").hide();
